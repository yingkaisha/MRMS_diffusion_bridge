...
model_name = '/glade/work/ksha/GAN/models/LDM_resize_atten{}-{}_res{}_gelu_base/'.format(
    N_atten1, N_atten2, num_res_blocks)

# location for saving new weights
model_name_save = '/glade/work/ksha/GAN/models/LDM_resize_atten{}-{}_res{}_gelu_tune/'.format(
    N_atten1, N_atten2, num_res_blocks)
