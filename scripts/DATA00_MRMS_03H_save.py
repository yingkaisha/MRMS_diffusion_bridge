...
for i_dt, dt in enumerate(date_list):
    ...
    filename = MRMS_dir+'MRMS_MultiSensor_QPE_03H_Pass2_00.00_{}.grib2'.format(dt_str)
    try:
...
label_save = ['MRMS',]
du.save_hdf5(tuple_save, label_save, '/glade/campaign/cisl/aiml/ksha/GFS/', 'MRMS_03H_y{}.hdf'.format(year))
