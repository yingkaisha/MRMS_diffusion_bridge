...
model_name = '/glade/work/ksha/GAN/models/LDM_resize_half-atten{}-{}_res{}_gelu_tune3/'.format(
    N_atten1, N_atten2, num_res_blocks)

# location for saving new weights
model_name_save = '/glade/work/ksha/GAN/models/LDM_resize_half-atten{}-{}_res{}_gelu_tune4/'.format(
    N_atten1, N_atten2, num_res_blocks)
...
def build_model(input_shape, gfs_shape, widths, feature_sizes, left_attention, right_attention, num_res_blocks=2, norm_groups=8,
                interpolation='bilinear', activation_fn=keras.activations.gelu,):
...
model = build_model(input_shape=input_shape, gfs_shape=gfs_shape, widths=widths, 
                    ...
                    num_res_blocks=num_res_blocks, norm_groups=norm_groups, activation_fn=keras.activations.gelu)
