...
has_attention = [True, True, True, True] # True: use multi-head attnetion on each up-/downsampling level
...
model_name = '/glade/work/ksha/GAN/models/LDM_atten{}_res{}_base/'.format(4, 2)

# location for saving new weights
model_name_save = '/glade/work/ksha/GAN/models/LDM_atten{}_res{}_base/'.format(4, 2)
