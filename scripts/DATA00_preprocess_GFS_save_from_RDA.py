...
if part == 0:
    ...
    LEADs = [30, 33, 36, 39, 42, 45, 48, 51, 54] 
elif part == 2:
    LEADs = [57, 60, 63, 66, 69, 72, 75, 78, 81]
elif part == 3:
    LEADs = [84, 87, 90, 93, 96, 99, 102, 105, 108] 
elif part == 4:
    LEADs = [111, 114, 117, 120, 123, 126, 129, 132, 135, 138]
else:
    LEADs = [141, 144, 147, 150, 153, 156, 159, 162, 165, 168]
...
date_list = [base + timedelta(days=d) for d in range(N_day)]
...
for str_ini in INIs:
    for lead in LEADs:
        ...
        name_check = '/glade/campaign/cisl/aiml/ksha/GFS/GFS_{}_ini{}_f{:02d}.hdf'.format(year, str_ini, lead)
        if os.path.isfile(name_check) is False:
            ...
            for i_dt, dt in enumerate(date_list):
                ...
                if os.path.isfile(filename_gfs):
                    try:
                        ...
                        print('Cannot read {}'.format(filename_gfs))
