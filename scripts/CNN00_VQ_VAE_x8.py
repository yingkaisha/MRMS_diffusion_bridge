...
filter_nums = [32, 48, 64]
latent_dim = 16
num_embeddings = 128
activation = 'relu'

model_name_save = '/glade/work/ksha/GAN/models/VQ_VAE_RES_x8_{}_{}_L{}_N{}_{}'.format(filter_nums[0], 
                                                                                      filter_nums[1], 
                                                                                      latent_dim, 
                                                                                      num_embeddings, 
                                                                                      activation)
...
latent_size = (32, 72, latent_dim) #(7, 7, latent_dim) #
# 64 144
...
X = resblock(X, 3, filter_nums[2], activation)
X = resblock(X, 3, filter_nums[2], activation)
